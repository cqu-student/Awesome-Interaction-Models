...
| 2025-05 | SALMONN-omni: A Standalone Speech LLM without Codec Injection for Full-duplex Conversation | [Paper](https://arxiv.org/abs/2505.17060) | [Code](https://github.com/bytedance/SALMONN) | 提出无音频 codec token 注入的单体全双工 Speech LLM，通过 Dynamic Thinking 在统一模型内部学习听、说、打断、附和与回声抑制 |
